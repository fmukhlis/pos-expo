...
>(
  (
    { className, containerClassName, type = "text", ...props },
    forwardedRef
  ) => {
      ...
      >
        ...
        {type === "password" && (
          ...
          >
            <Icon
              size={20}
              className="text-light-secondaryText dark:text-dark-secondaryText"
              name={isPasswordShowed ? "eye-off-outline" : "eye-outline"}
            />
          </TouchableOpacity>
        )}
      </View>
