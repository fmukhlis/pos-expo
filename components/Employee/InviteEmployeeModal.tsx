...
const InviteEmployeeModal = ({
    ...
    const { getOutgoingEmployeeInvitations, getUserByEmail, inviteEmployees } = useEmployeeAPI()
    ...
    const [getUserByEmailLoading, setGetUserByEmailLoading] = React.useState(false)
    const [inviteEmployeesLoading, setInviteEmployeesLoading] = React.useState(false)
    ...
    const invite = () => {
        if (selectedStore) {
            inviteEmployees({
                ...
                onStart: () => { setInviteEmployeesLoading(true) },
                onSuccess: () => {
...
interface InviteEmployeeModalProps extends React.ComponentPropsWithoutRef<typeof Modal> {
