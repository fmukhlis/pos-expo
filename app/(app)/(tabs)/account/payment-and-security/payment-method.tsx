...
import { useGetPaymentMethodsQuery } from '@/components/services/paymentMethods'
...
const PaymentMethod = () => {
    ...
    React.useEffect(() => {
        dispatch(setSelectedPaymentMethodId(paymentMethods ? paymentMethods[0].id : null))
    }, [paymentMethods])

    React.useEffect(() => { getStore({ storeId }, true) }, [])
